...
const API_PRODUCTOS2U = '../../core/api/commerce/Productos2U.php?action=';
...
function obtenerIdProductosU(){
    $.ajax({
        dataType: 'json',
        url: API_PRODUCTOS2U + 'obtenerID'
    })
    .done(function( response ) {
        ...
        if ( response.status ) {
            ...
            response.dataset.forEach(function( row ) {
                ...
                $('.CajaScrollProductos2U').html( content );
                ...
                llenarCarruselesU(`${row.id_tipo_producto}`);
            });
        }
    })
    .fail(function( jqXHR ) {
...
function llenarCarruselesU( id ){
    $.ajax({
        dataType: 'json',
        url: API_PRODUCTOS2U + 'readProductos',
        data: { id_tipo: id },
        type: 'post'
    })
    .done(function( response ) {
