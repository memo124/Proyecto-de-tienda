<?php
/*
*	Creación de clase Productos2 que es heredada de Validator.
*/
class Productos2 extends Validator
{
    /*Creación de atributos a utilizar en la Clase Productos2 heredada de Validator.*/
    private $id = null;
    /*
    ...
    */
    ...
    {
        $sql = 'SELECT P.NOMBRE_PRODUCTO, P.IMAGEN, M.MARCAS, P.PRECIO, T.PROMOCION FROM PRODUCTOS P
                INNER JOIN ESTADO_PRODUCTOS EP USING (ID_ESTADO_PRODUCTO)
