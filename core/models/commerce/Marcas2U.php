<?php
/*
*	Creación de clase Marcas2U que es heredada de Validator.
*/
class Marcas2U extends Validator
{
    /*Creación de atributos a utilizar en la Clase Marcas2U heredada de Validator.*/
    private $id = null;
    /*
    ...
    */
    ...
    {
        $sql = 'SELECT P.ID_PRODUCTOS, M.MARCAS,P.NOMBRE_PRODUCTO, T.TIPO_PRODUCTO, P.IMAGEN, P.PRECIO, T.PROMOCION FROM MARCAS M
