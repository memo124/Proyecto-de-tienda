...
Commerce::headerCommerce( 'Productos por tipos', 3 );
?>
...
<div class="principal" id="CajaPrincipalMarcas2">
    <div class="row">
        <div class="col l12 m12 s12">
            <div class="card-panel z-depth-5 center-align CajaScrollProductos2U" id="CajaSlider">
            </div>
        </div>
    </div>
</div>
...
<?php
require_once('../../core/helpers/Comercial.php');
Commerce::footerCommerce( 'Productos2U' );
?>
